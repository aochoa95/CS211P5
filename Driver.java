...
public class Driver {
	...
	public static Node runLLAdd() {
		...
		System.out.println("done adding " + MAX_SIZE
				+ " people in sorted linked list in \t\t" + (end - begin));
		return start;
	}
	...
	public static void runLLSearch(Node start) {
		...
		long end = System.nanoTime();
		System.out.println("done searching linked list for " + found.toString()
				+ " in \t\t" + (end - begin));
	}
	...
	public static ArrayList runArrayListAdd(boolean sort) {
		...
		long end = System.nanoTime();
		System.out.println("done adding " + MAX_SIZE + " people in " + msg
				+ " ArrayList in \t\t" + (end - begin));
		return list;
	}
	...
	public static void runArrayListSearch(ArrayList list, boolean sorted) {
		...
		long end = System.nanoTime();
		System.out.println("done searching " + msg + "ArrayList for " + found
				+ " in \t\t\t" + (end - begin));
	}
	...
	public static Person[] runArrayAdd() {
		...
		long end = System.nanoTime();
		System.out.println("done adding " + MAX_SIZE
				+ " people in unsorted small array in \t\t" + (end - begin));
		return array;
	}
	...
	public static void runArraySearch(Person[] small) {
		...
		long end = System.nanoTime();
		System.out.println("done searching sorted small array for  " + mid
				+ " in \t\t" + (end - begin));
	}
